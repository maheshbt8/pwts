...
class Auth extends MX_Controller {
	...
	public function test($value='')
        {
            $r=sendEmail(NULL,'maheshbt8@gmail.com', 'Sdsn bond', 'Please check your bond', NULL, NULL, NULL, NULL, NULL, ['name' => 'SDSN-DOC', 'format' => 'pdf']);
            if($r){
                echo "string";
            }else{
                echo "strings";
	...
	public function login()
	{
		...
		if ($this->form_validation->run() == true)
		{
			...
			if (! $login_one)
			{   
			    $this->ion_auth_model->identity_column = 'unique_id';$this->config->set_item('identity', 'unique_id');
